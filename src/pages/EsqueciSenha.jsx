...
const EsqueciSenha = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setEmail("");
      setMensagem("📧 Se o e-mail informado estiver cadastrado, você receberá um link para redefinir sua senha.");
      ...
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className={`rounded-lg h-12 font-bold text-white transition ${
              loading
